        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              ...
              Skor &amp; Penilaian Klinis Neonatus
            </h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Pilih instrumen skoring klinis terstandar di bawah ini untuk memulai evaluasi pasien.</p>
          </div>

...
export const SEARCH_INDEX: SearchItem[] = [
  ...
  { id: 'a-abx', title: 'Kalkulator Antibiotik Neonatus', description: 'Ampisilin, Gentamisin, Cefotaxime — dosis berdasarkan GA, BB, usia postnatal', keywords: ['antibiotik','ampisilin','gentamisin','cefotaxime','eons','lons','sepsis','meningitis','dosis'], tab: 'advanced', badge: 'Kalkulator', badgeColor: 'bg-rose-100 dark:bg-rose-950 text-rose-700 dark:text-rose-300' },
  { id: 'a-uvc', title: 'Kedalaman Kateter UVC & UAC', description: 'Hitung kedalaman umbilical venous/arterial catheter berdasarkan berat lahir', keywords: ['uvc','uac','kateter','umbilikal','kedalaman','vena','arteri','neonatus'], tab: 'advanced', badge: 'Kalkulator', badgeColor: 'bg-teal-100 dark:bg-teal-950 text-teal-700 dark:text-teal-300' },
  { id: 'a-seizure', title: 'Manajemen Kejang Neonatus', description: 'Fenobarbital, Levetiracetam, Midazolam, Fenitoin — dosis loading dan maintenance', keywords: ['kejang','seizure','fenobarbital','levetiracetam','midazolam','fenitoin','neonatus','antikonvulsan'], tab: 'advanced', badge: 'Kalkulator', badgeColor: 'bg-purple-100 dark:bg-purple-950 text-purple-700 dark:text-purple-300' },
  { id: 'a-convert', title: 'Konversi Unit Klinis', description: 'mcg/kg/mnt ke mL/jam, konsentrasi larutan, dosis obat, konversi berat', keywords: ['konversi','unit','mcg','mg','ml/jam','dosis','infus','konsentrasi'], tab: 'advanced', badge: 'Kalkulator', badgeColor: 'bg-orange-100 dark:bg-orange-950 text-orange-700 dark:text-orange-300' },
  { id: 'p-dashboard', title: 'Dashboard Pasien', description: 'Identitas pasien, skor klinis, status resusitasi, log tindakan terintegrasi', keywords: ['dashboard','pasien','identitas','skor','status','log','ringkasan'], tab: 'dashboard', badge: 'Dashboard', badgeColor: 'bg-indigo-100 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-300' },
  { id: 'p-settings', title: 'Pengaturan & Info', description: 'Font, ukuran teks, mode tampilan, skema warna, cache, dan tentang aplikasi', keywords: ['pengaturan','setting','about','font','tema','dark mode','cache','reset'], tab: 'settings', badge: 'Pengaturan', badgeColor: 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300' },
